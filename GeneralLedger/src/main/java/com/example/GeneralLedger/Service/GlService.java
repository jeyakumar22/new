...
public class GlService {
    ...
    public LedgerResponseDTO getAccountLedger(String accountCode) {
        ...
        for (GeneralLedgerEntry gl : glEntries) {
            ...
            // convert LocalDate to LocalDateTime if your entity stores LocalDate:
            entry.setDate(gl.getEntryDate().atStartOfDay());
            // if your entity has journalEntry as object:
            ...
            entry.setRunningBalance(gl.getRunningBalance()); // stored in DB, no calculation
        ...
        // final balance from LAST gl entry
